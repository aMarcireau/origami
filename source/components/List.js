...
class List extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        const numberOfPages = Math.ceil(
            nextProps.elements.length / nextProps.elementsPerPage
        );
        if (numberOfPages === 0) {
    ...
    navigationBar(id) {
        const numberOfPages = Math.ceil(
            this.props.elements.length / this.props.elementsPerPage
        );
        return (
            numberOfPages > 1 && (
                <ul
    ...
    render() {
        ...
        return numberOfPages > 0 ? (
            <div>
                ...
                {this.props.pageFromElements(
                    this.props.elements.slice(
                        (this.state.activePage - 1) *
