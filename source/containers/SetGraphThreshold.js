            ...
            >
                ...
                <div
                    style={{
                        ...
                        top: "17.5px",
                        left: `${
                            ((this.props.threshold - 1) /
                                (this.props.thresholdLimit - 1)) *
                                this.props.width +
                            5
                        }px`,
                        width: `${
                    ...
                    <polygon
                        ...
                        style={{
                            fill:
                                ...
                                "SetGraphThresholdHorizontallyMovable"
                ...
                >
                    ...
                    >
                        {this.props.threshold === this.props.thresholdLimit
                            ? "∞"
                ...
                <HorizontallyMovable
                    ...
                    move={position => {
                        const newGraphThreshold = Math.round(
                            ((position - this.props.left) / this.props.width) *
                                (this.props.thresholdLimit - 1) +
                                1
                        );
                        if (newGraphThreshold !== this.props.threshold) {
                            this.props.dispatch(
                                setGraphThreshold(newGraphThreshold)
                            );
                        }
                    }}
                    style={{
