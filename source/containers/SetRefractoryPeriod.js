            ...
            >
                    ...
                    style={{
                        ...
                        left: `${
                            (this.props.minimumRefractoryPeriod /
                                this.props.refractoryPeriodLimit) *
                            this.props.width
                        }px`,
                        width: `${
                ...
                >
                    <polygon
                        ...
                        style={{
                            fill:
                                this.props.mouseOwner ===
                                "SetRefractoryPeriodLeftSideHorizontallyMovable"
                ...
                >
                    ...
                    >
                        {`${(this.props.minimumRefractoryPeriod / 1000).toFixed(
                            1
                        )} s`}
                    </div>
                </div>
                <div
                    style={{
                        ...
                        visibility:
                            this.props.mouseOwner ===
                            "SetRefractoryPeriodRightSideHorizontallyMovable"
                                ? "visible"
                                : "hidden",
                        opacity:
                            this.props.mouseOwner ===
                ...
                >
                    ...
                    >
                        {`${(this.props.maximumRefractoryPeriod / 1000).toFixed(
                            1
                        )} s`}
                    </div>
                </div>
                ...
                <HorizontallyMovable
                    ...
                    move={position => {
                        this.props.dispatch(
                            setScholarRequestRefractoryPeriod(
