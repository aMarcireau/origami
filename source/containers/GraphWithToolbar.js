            ...
            >
                ...
                >
                    <button
                        ...
                        onClick={() => {
                            this.props.dispatch(
                                setGraphZoomAndOffset(this.props.zoom, 0, 0)
                            );
                        }}
                    >
                        Center
                ...
                >
                    ...
                    >
                        ...
                        <span
                            key={
                                this.props.selectedPublication == null
                                    ? "null"
                                    : this.props.selectedPublication.doi
                            }
                            style={{
                                height: "39px",
                                color:
                                    this.props.selectedPublication == null ||
                                    !this.props.selectedPublication.locked
                                        ? this.props.colors.secondaryContent
                                        : this.props.colors.link,
                                fontSize: "14px",
                                paddingLeft: "10px",
...
export default connect(state => {
    const selectedPublicationCandidates = Array.from(
        state.publications.entries()
    )
        .filter(([doi, publication]) => publication.selected)
        .map(([doi, publication]) => {
            return {
                ...publication,
                doi,
    ...
    return {
        ...
        selectedPublication:
            selectedPublicationCandidates.length > 0
                ? selectedPublicationCandidates[0]
                : null,
