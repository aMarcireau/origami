            ...
            >
                ...
                <svg
                    style={{
                        position: "absolute",
                        left: `${
                            ((this.props.zoom - this.props.zoomMinimum) /
                                (this.props.zoomMaximum -
                                    this.props.zoomMinimum)) *
                                this.props.width -
                            5
                        }px`,
                        top: "10.5px",
                    ...
                    <polygon
                        ...
                        style={{
                            fill:
                                ...
                                "SetGraphZoomHorizontallyMovable"
                ...
                <HorizontallyMovable
                    ...
                    position={
                        this.props.left +
                        ((this.props.zoom - this.props.zoomMinimum) /
                            (this.props.zoomMaximum - this.props.zoomMinimum)) *
                            this.props.width
                    }
                    rightLimit={this.props.left + this.props.width + 1}
                    move={position => {
                        const newGraphZoom = Math.round(
