...
//                                position: 'absolute',
                        ...
                        >
                            {this.props.elements.map((element, index) => (
                                <div key={`${this.props.hash}-${this.props.id}-${element.name}-${index}-wrapper`}>
                                    <div
                                        key={`${this.props.hash}-${this.props.id}-${element.name}-${index}`}
                                        style={{
                                            whiteSpace: 'nowrap',
                                            lineHeight: '30px',
                                            cursor: element.onClick == null ? '' : 'pointer',
                                            ':hover': {}
                                        }}
                                    >
                                        <div
                                        ...
                                        <div style={{
                                            ...
                                            {`${element.shortcut !== element.shortcut.toLowerCase() ? '⇧' : ''}${this.modifier}`}
                                        </div>
                                        <div style={{
                                            display: 'inline-block',
                                            width: '20px',
    ...
    onMouseEnter() {
        if (this.props.activeMenuItem != null && this.props.activeMenuItem !== this.props.id) {
