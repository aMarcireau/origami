...
| [<img src="linux.png" width="50px"/>](https://github.com/aMarcireau/origami/releases/download/v0.9.1/Origami-linux-x64.zip) | [<img src="macOs.png" width="50px"/>](https://github.com/aMarcireau/origami/releases/download/v0.9.1/Origami-darwin-x64.zip) | [<img src="windows.png" width="50px"/>](https://github.com/aMarcireau/origami/releases/download/v0.9.1/Origami-win32-x64.zip) |
| ------------------------------------ | ------------------------------------ | ---------------------------------------|
| [Download for Linux](https://github.com/aMarcireau/origami/releases/download/v0.9.1/Origami-linux-x64.zip) | [Download for macOS](https://github.com/aMarcireau/origami/releases/download/v0.9.1/Origami-darwin-x64.zip) | [Download for Windows](https://github.com/aMarcireau/origami/releases/download/v0.9.1/Origami-win32-x64.zip) |
...
```yaml
{
    "appVersion": "0.9.1", # the version of the app used to generate this save
