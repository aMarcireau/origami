    ...
    passwordInterface.question("", password => {
        ...
        request.post(
            ...
            (error, httpIncomingMessage, body) => {
                ...
                const id = body.id;
                console.log(
                    `Created the release v${versionAsString} (id: ${id})`
                );
                request.get(
                    {
                    ...
                    (error, httpIncomingMessage, body) => {
                        if (error) {
                            console.error(
                                `https://api.github.com/repos/amarcireau/origami/releases/${id}`,
                                error
                            );
                            process.exit(1);
                        }
                        ...
                        try {
                            fs.mkdirSync(
                                `${path.dirname(__dirname)}/build/archives`
                            );
                        } catch (error) {}
                        let directoriesLeft = 0;
                        for (const directoryToZip of fs.readdirSync(
                            `${path.dirname(__dirname)}/build`
                        )) {
                            if (
                                fs
                                    .lstatSync(
                                ...
                                if (matchedConfiguration != null) {
                                    ...
                                    const output = fs.createWriteStream(
                                        `${path.dirname(
                                            __dirname
                                        )}/build/archives/${directoryToZip}.zip`
                                    );
                                    output.on("close", () => {
                                        console.log(
                                        ...
                                        fs.readFile(
                                            ...
                                            (error, archive) => {
                                                ...
                                                const url = urlTemplate
                                                    .parse(body.upload_url)
                                                    .expand({
                                                        name: `${directoryToZip}.zip`,
                                                    });
                                                request.post(
                                                    {
                                                        url,
                                                    ...
                                                    (
                                                        ...
                                                        if (
                                                            httpIncomingMessage.statusCode !==
                                                            201
                                                        ) {
                                                            console.error(
                                                                url,
                                                            ...
                                                            request.get(
                                                                ...
                                                                (
                                                                        ...
                                                                        if (
                                                                            ...
                                                                            if (
                                                                                ...
                                                                                const releaseVersion =
                                                                                    {
                                                                                        major: parseInt(
                                                                                            releaseSemverMatch[1]
                                                                                        ),
                                                                                        minor: parseInt(
                                                                                            releaseSemverMatch[2]
                                                                                        ),
                                                                                        patch: parseInt(
                                                                                            releaseSemverMatch[3]
                                                                                        ),
                                                                                        identifier:
                                                                                            releaseSemverMatch[4]
                                                                                                ? releaseSemverMatch[4]
                                                                                                : null,
                                                                                    };
                                                                                if (
                                                                                    ...
                                                                                    request.delete(
                                                                                        ...
                                                                                        (
                                                                                            ...
                                                                                            console.log(
                                                                                                `${release.tag_name} (${release.id}) deleted (it was a draft)`
                                                                                            );
                                                                                        }
                                                                                    );
                                                                                } else if (
                                                                                    releaseVersion.identifier
                                                                                ) {
                                                                                    console.log(
                                                                                        `${release.tag_name} (${release.id}) has an identifier: skipping automatic operations`
                                                                                    );
                                                                                } else if (
                                                                                    isSmallerThan(
                                                                                        version,
                                                                                    ...
                                                                                    console.log(
                                                                                        `${release.tag_name} (${release.id}) is greater than or identical to the current version: skipping automatic operations`
                                                                                    );
                                                                                } else {
                                                                                ...
                                                                                console.log(
                                                                                    `${release.tag_name} (${release.id}) does not have the expected format: skipping automatic operations`
                                                                                );
                                                                            }
                                                                        }
                                                                    }
                                                                    ...
                                                                    for (const releaseAndVersion of releasesAndVersionsToPurge) {
                                                                        ...
                                                                        for (const asset of releaseAndVersion
                                                                            .release
                                                                            .assets) {
                                                                            request.delete(
                                                                                {
                                                                                ...
                                                                                (
                                                                                    ...
                                                                                    console.log(
                                                                                        `${asset.name} of ${releaseAndVersion.release.tag_name} (${asset.id} of ${releaseAndVersion.release.id}) deleted (expired version)`
                                                                                    );
                                                                                }
                                                                            );
                                                                        }
                                    ...
                                    archive.pipe(output);
                                    if (
                                        matchedConfiguration[1] === "darwin" ||
                                        matchedConfiguration[1] === "mas"
                                    ) {
                                        ...
                                        child_process.execSync(
                                            `cp -R '${path.dirname(
                                                __dirname
                                            )}/build/${directoryToZip}/Origami.app' '${path.dirname(
                                                __dirname
                                            )}/build/archives/${directoryToZip}/Origami.app'`
                                        );
                                        const frameworks = `${path.dirname(
                                            __dirname
                                        )}/build/archives/${directoryToZip}/Origami.app/Contents/Frameworks`;
                                        for (const frameworkFile of fs.readdirSync(
                                            frameworks
                                        )) {
                                            if (
                                                path.extname(frameworkFile) ===
                                                ".framework"
                                            ) {
                                                ...
                                                for (const element of fs.readdirSync(
                                                    ...
                                                    if (
                                                        ...
                                                        child_process.execSync(
                                                            `rm -rf '${framework}/${element}'`
                                                        );
                                                        child_process.execSync(
                                                            `cp -R '${framework}/Versions/A/${element}' '${framework}/${element}'`
                                                        );
                                                    }
                                                }
                                                child_process.execSync(
